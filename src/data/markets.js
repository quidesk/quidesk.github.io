...
export const MARKET_DATA = {
  equities: [
    withHistory({ id:'spx',  symbol:'SPY',      name:'S&P 500 (SPY)',      price:764.39,  change:-0.17, volume:'60M', marketCap:'540B', sector:'equities' }, 3.2),
    withHistory({ id:'ndx',  symbol:'QQQ',      name:'NASDAQ (QQQ)',       price:708.50,  change:-0.69, volume:'40M', marketCap:'300B', sector:'equities' }, 4.1),
    withHistory({ id:'dow',  symbol:'DIA',      name:'Dow Jones (DIA)',    price:533.69,  change:0.27,  volume:'5M',  marketCap:'35B',  sector:'equities' }, 1.5),
    withHistory({ id:'aapl', symbol:'AAPL',     name:'Apple Inc.',         price:310.99,  change:0.53,  volume:'58M', marketCap:'3.5T', sector:'equities' }, 3.2),
    withHistory({ id:'nvda', symbol:'NVDA',     name:'NVIDIA Corp.',       price:209.79,  change:-2.29, volume:'42M', marketCap:'3.4T', sector:'equities' }, 4.2),
    withHistory({ id:'tsla', symbol:'TSLA',     name:'Tesla Inc.',         price:352.65,  change:-2.81, volume:'98M', marketCap:'1.1T', sector:'equities' }, 9.5),
  ],
  crypto: [
    withHistory({ id:'btc',  symbol:'BTC',      name:'Bitcoin',            price:78992.20,change:1.62,  volume:'28.4B',marketCap:'1.44T', sector:'crypto' }, 850),
    withHistory({ id:'eth',  symbol:'ETH',      name:'Ethereum',           price:2478.86, change:0.64,  volume:'14.2B',marketCap:'282B',  sector:'crypto' }, 52),
    withHistory({ id:'sol',  symbol:'SOL',      name:'Solana',             price:96.33,   change:0.95,  volume:'3.8B', marketCap:'88B',   sector:'crypto' }, 6.2),
    withHistory({ id:'bnb',  symbol:'BNB',      name:'BNB',                price:704.28,  change:0.34,  volume:'1.9B', marketCap:'94B',   sector:'crypto' }, 12),
    withHistory({ id:'xrp',  symbol:'XRP',      name:'XRP',                price:1.482,   change:-2.59, volume:'2.1B', marketCap:'138B',  sector:'crypto' }, 0.07),
    withHistory({ id:'ada',  symbol:'ADA',      name:'Cardano',            price:0.220,   change:-2.73, volume:'820M', marketCap:'28B',   sector:'crypto' }, 0.024),
  ],
  metals: [
    withHistory({ id:'gold',     symbol:'XAU/USD', name:'Gold Spot',       price:4689.00, change:0.17,  volume:'142B', marketCap:'14.6T', sector:'metals', unit:'oz' }, 24),
    withHistory({ id:'silver',   symbol:'XAG/USD', name:'Silver Spot',     price:68.55,   change:-1.40, volume:'18B',  marketCap:'1.7T',  sector:'metals', unit:'oz' }, 1.1),
    withHistory({ id:'platinum', symbol:'XPT/USD', name:'Platinum',        price:1885.00, change:-0.56, volume:'4.2B', marketCap:'—',     sector:'metals', unit:'oz' }, 16),
  ],
  forex: [
    withHistory({ id:'eurusd', symbol:'EUR/USD', name:'Euro / US Dollar',  unit:'USD', pricePrefix:'$', price:1.1660, change:-0.10, volume:'580B', marketCap:'—', sector:'forex' }, 0.003),
    withHistory({ id:'gbpusd', symbol:'GBP/USD', name:'British Pound / USD', unit:'USD', pricePrefix:'$', price:1.3630, change:-0.10, volume:'310B', marketCap:'—', sector:'forex' }, 0.004),
    withHistory({ id:'usdjpy', symbol:'USD/JPY', name:'US Dollar / Yen',   unit:'JPY', pricePrefix:'¥', price:159.18, change:0.15,  volume:'430B', marketCap:'—', sector:'forex' }, 0.45),
    withHistory({ id:'audusd', symbol:'AUD/USD', name:'Australian Dollar / USD', unit:'USD', pricePrefix:'$', price:0.7150, change:-0.33, volume:'170B', marketCap:'—', sector:'forex' }, 0.002),
    withHistory({ id:'usdcad', symbol:'USD/CAD', name:'US Dollar / CAD',   unit:'CAD', pricePrefix:'C$', price:1.3850, change:0.63,  volume:'160B', marketCap:'—', sector:'forex' }, 0.003),
    withHistory({ id:'usdchf', symbol:'USD/CHF', name:'US Dollar / CHF',   unit:'CHF', pricePrefix:'Fr', price:0.8020, change:0.21,  volume:'130B', marketCap:'—', sector:'forex' }, 0.002),
    withHistory({ id:'eurgbp', symbol:'EUR/GBP', name:'Euro / GBP',        unit:'GBP', pricePrefix:'£', price:0.8550, change:-0.07, volume:'90B',  marketCap:'—', sector:'forex' }, 0.002),
    withHistory({ id:'usdinr', symbol:'USD/INR', name:'US Dollar / INR',   unit:'INR', pricePrefix:'₹', price:95.73,  change:0.04,  volume:'40B',  marketCap:'—', sector:'forex' }, 0.18),
