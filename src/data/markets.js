...
export const MARKET_DATA = {
  ...
  crypto: [
    { id:'btc',  symbol:'BTC',      name:'Bitcoin',            price:72796,   change:rp(4),  volume:'28.4B',marketCap:'1.44T', sector:'crypto',   chartData:randomWalk(72796,850,72) },
    { id:'eth',  symbol:'ETH',      name:'Ethereum',           price:2341.60, change:rp(5),  volume:'14.2B',marketCap:'282B',  sector:'crypto',   chartData:randomWalk(2341,52,72) },
    { id:'sol',  symbol:'SOL',      name:'Solana',             price:185.20,  change:rp(7),  volume:'3.8B', marketCap:'88B',   sector:'crypto',   chartData:randomWalk(185,6.2,72) },
    { id:'bnb',  symbol:'BNB',      name:'BNB',                price:628.40,  change:rp(4),  volume:'1.9B', marketCap:'94B',   sector:'crypto',   chartData:randomWalk(628,12,72) },
    { id:'xrp',  symbol:'XRP',      name:'XRP',                price:2.4180,  change:rp(6),  volume:'2.1B', marketCap:'138B',  sector:'crypto',   chartData:randomWalk(2.4180,0.07,72) },
    { id:'ada',  symbol:'ADA',      name:'Cardano',            price:0.7820,  change:rp(5),  volume:'820M', marketCap:'28B',   sector:'crypto',   chartData:randomWalk(0.7820,0.024,72) },
  ],
  metals: [
    { id:'gold',     symbol:'XAU/USD', name:'Gold Spot',       price:4510.90, change:rp(1.5),volume:'142B', marketCap:'14.6T', sector:'metals',  unit:'oz',    chartData:randomWalk(4510,24,72) },
    { id:'silver',   symbol:'XAG/USD', name:'Silver Spot',     price:68.36,   change:rp(2.5),volume:'18B',  marketCap:'1.7T',  sector:'metals',  unit:'oz',    chartData:randomWalk(68.36,1.1,72) },
    { id:'platinum', symbol:'XPT/USD', name:'Platinum',        price:1833.00, change:rp(2),  volume:'4.2B', marketCap:'—',     sector:'metals',  unit:'oz',    chartData:randomWalk(1833,16,72) },
    ],
  forex: [
    { id:'eurusd', symbol:'EUR/USD', name:'Euro / US Dollar',  unit:'USD', pricePrefix:'$', price:1.1680, change:0.12,  volume:'580B', marketCap:'—', sector:'forex', chartData:randomWalk(1.1680,0.003,72) },
    { id:'gbpusd', symbol:'GBP/USD', name:'British Pound / US Dollar', unit:'USD', pricePrefix:'$', price:1.3420, change:-0.08, volume:'310B', marketCap:'—', sector:'forex', chartData:randomWalk(1.3420,0.004,72) },
    { id:'usdjpy', symbol:'USD/JPY', name:'US Dollar / Japanese Yen',  unit:'JPY', pricePrefix:'¥', price:142.35, change:0.22,  volume:'430B', marketCap:'—', sector:'forex', chartData:randomWalk(142.35,0.45,72) },
    { id:'audusd', symbol:'AUD/USD', name:'Australian Dollar / USD',   unit:'USD', pricePrefix:'$', price:0.6680, change:-0.15, volume:'170B', marketCap:'—', sector:'forex', chartData:randomWalk(0.6680,0.002,72) },
    { id:'usdcad', symbol:'USD/CAD', name:'US Dollar / Canadian Dollar', unit:'CAD', pricePrefix:'C$', price:1.3580, change:0.09,  volume:'160B', marketCap:'—', sector:'forex', chartData:randomWalk(1.3580,0.003,72) },
    { id:'usdchf', symbol:'USD/CHF', name:'US Dollar / Swiss Franc',   unit:'CHF', pricePrefix:'Fr', price:0.8520, change:-0.06, volume:'130B', marketCap:'—', sector:'forex', chartData:randomWalk(0.8520,0.002,72) },
    { id:'eurgbp', symbol:'EUR/GBP', name:'Euro / British Pound',      unit:'GBP', pricePrefix:'£', price:0.8710, change:0.04,  volume:'90B',  marketCap:'—', sector:'forex', chartData:randomWalk(0.8710,0.002,72) },
    { id:'usdinr', symbol:'USD/INR', name:'US Dollar / Indian Rupee',  unit:'INR', pricePrefix:'₹', price:95.62,  change:0.08,  volume:'40B',  marketCap:'—', sector:'forex', chartData:randomWalk(95.62,0.18,72) },
  ],
  energy: [
